...
Design and implement a (partial) Battleship game as a mobile app (React Native).
...
You may use the provided JSON data (see below) indicating the position of the ships. The game should be responsive and can be played in portrait and landscape modes.

You need to use React Native (either plain React Native or Expo) and Typescript for the implementation. You may use Redux, Zustand, Provider / Context or any other library you think is suitable for this project. It's not necessary to save game state or anything like that.
